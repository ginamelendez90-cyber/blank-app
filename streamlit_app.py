...
# FUNCIÓN PARA CONVERTIR TEXTO A NÚMERO (CORRIGE COMAS Y PUNTOS DECIMALES)
def a_numero(serie):
...
# Lista de mecánicos dinámica (combina lista fija con lo que encuentre en Google Sheets)
